...
promote_chunks_cloud_run_ppdb_config_uri = "gs://ppdb-dev-config/ppdb-dev_config.yaml"

# Track Chunk Cloud Run
track_chunk_cloud_run_ppdb_config_uri = "gs://ppdb-dev-config/ppdb-dev_config.yaml"
