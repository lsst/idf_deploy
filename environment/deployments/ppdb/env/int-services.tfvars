...
promote_chunks_cloud_run_ppdb_config_uri = "gs://ppdb-int-ingest/ppdb-int_config.yaml"

# Track Chunk Cloud Run
track_chunk_cloud_run_ppdb_config_uri = "gs://ppdb-int-ingest/ppdb-int_config.yaml"
