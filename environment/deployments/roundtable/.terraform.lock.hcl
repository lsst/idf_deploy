...
provider "registry.terraform.io/hashicorp/google" {
  version     = "6.50.0"
  constraints = ">= 3.33.0, >= 3.43.0, >= 3.53.0, >= 3.83.0, >= 4.25.0, >= 4.28.0, >= 4.64.0, >= 5.0.0, >= 5.31.0, >= 5.41.0, >= 6.37.0, < 7.0.0, < 8.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "6.50.0"
  constraints = ">= 3.43.0, >= 4.11.0, >= 4.64.0, >= 5.0.0, >= 5.41.0, >= 6.13.0, < 7.0.0"
  hashes = [
